/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 867b0830b49afbb164e1c6b227de29d1)
// Runtime types generated with workerd@1.20260722.1 2026-02-02 web_socket_auto_reply_to_close
interface __BaseEnv_Env {
	BROWSER: BrowserRun;
	CDP_SECRETS: string;
	CDP_SESSIONS: DurableObjectNamespace<import("./src/index").BrowserSession>;
	LIVE_VIEW_LINKS: DurableObjectNamespace<import("./src/index").LiveViewLink>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BrowserSession" | "LiveViewLink";
	}
